...
customElements.define('action-handler-weather-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-weather-card')) {
    return body.querySelector('action-handler-weather-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-weather-card');
